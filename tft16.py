...
if run:
    ...
    with tab4:
        ...
        # --- HÀM render_unlock ĐƯỢC ĐỊNH NGHĨA TẠI ĐÂY ---
        def render_unlock(sub_tab, u_pool):
            # [QUAN TRỌNG] Dòng with này phải thụt vào so với def
            with sub_tab:
